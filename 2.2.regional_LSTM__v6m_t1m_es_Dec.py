...
if __name__ == "__main__":
    ...
    rmse_path = [r'D:\beijing\rmse\rmse_regional_4_nan_avg_0_v6m_t1m_es_Dec.csv',
                 r'D:\beijing\rmse\rmse_regional_6_nan_avg_0_v6m_t1m_es_Dec.csv',
                 r'D:\beijing\rmse\rmse_regional_11_nan_avg_v6m_t1m_es_Dec.csv']
    pred_path = [r'D:\beijing\pred\pred_regional_4_nan_avg_0_v6m_t1m_es_Dec.csv',
                 r'D:\beijing\pred\pred_regional_6_nan_avg_0_v6m_t1m_es_Dec.csv',
                 r'D:\beijing\pred\pred_regional_11_nan_avg_0_v6m_t1m_es_Dec.csv']
    obs_path = [r'D:\beijing\obs\obs_regional_4_nan_avg_0_v6m_t1m_es_Dec.csv',
                r'D:\beijing\obs\obs_regional_6_nan_avg_0_v6m_t1m_es_Dec.csv',
                r'D:\beijing\obs\obs_regional_11_nan_avg_0_v6m_t1m_es_Dec.csv']
    para_path = [r'D:\beijing\para\para_regional_nan_avg_0_v6m_t1m_es_Dec\4.pth',
                 r'D:\beijing\para\para_regional_nan_avg_0_v6m_t1m_es_Dec\6.pth',
                 r'D:\beijing\para\para_regional_nan_avg_0_v6m_t1m_es_Dec\11.pth']
    ###################
    # start go go go! #
    ###################
    for exp in range(3):
        ...
        with tqdm(total=point_nums) as pbar:
            for num in range(34):
                ...
                if num == (point_nums - 1):
                    torch.save(para_last_point, para_path[exp])
                pbar.update(1)
