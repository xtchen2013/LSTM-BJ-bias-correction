...
if __name__ == "__main__":
    ...
    train_end = pd.to_datetime("2018-11-30 23:00:00", format="%Y-%m-%d %H:%M:%S")
    validate_start = pd.to_datetime("2018-12-01 00:00:00", format="%Y-%m-%d %H:%M:%S")
    ...
    rmse_path = [r'D:\beijing\rmse\rmse_simple_4_nan_avg_0_v12m_t1m.csv',
                 r'D:\beijing\rmse\rmse_simple_6_nan_avg_0_v12m_t1m.csv',
                 r'D:\beijing\rmse\rmse_simple_11_nan_avg_v12m_t1m.csv']
    pred_path = [r'D:\beijing\pred\pred_simple_4_nan_avg_0_v12m_t1m.csv',
                 r'D:\beijing\pred\pred_simple_6_nan_avg_0_v12m_t1m.csv',
                 r'D:\beijing\pred\pred_simple_11_nan_avg_0_v12m_t1m.csv']
    obs_path = [r'D:\beijing\obs\obs_simple_4_nan_avg_0_v12m_t1m.csv',
                r'D:\beijing\obs\obs_simple_6_nan_avg_0_v12m_t1m.csv',
                r'D:\beijing\obs\obs_simple_11_nan_avg_0_v12m_t1m.csv']
    ###################
    # start go go go! #
    ###################
    for exp in range(3):
        ...
        if exp == 0:
            input_size = 4
            para_path = [r'D:\beijing\para\para_simple_4_nan_avg_0_v12m_t1m\4_' + str(i) + '.pth' for i in range(point_nums)]
            continue
        if exp == 1:
            input_size = 6
            para_path = [r'D:\beijing\para\para_simple_6_nan_avg_0_v12m_t1m\6_' + str(i) + '.pth' for i in range(point_nums)]
            continue
        if exp == 2:
            input_size = 11
            para_path = [r'D:\beijing\para\para_simple_11_nan_avg_0_v12m_t1m\11_' + str(i) + '.pth' for i in range(point_nums)]
