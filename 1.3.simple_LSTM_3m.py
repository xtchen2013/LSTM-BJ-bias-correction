...
if __name__ == "__main__":
    ...
    validate_end = pd.to_datetime("2019-9-30 23:00:00", format="%Y-%m-%d %H:%M:%S")
    test_start = pd.to_datetime("2019-10-01 00:00:00", format="%Y-%m-%d %H:%M:%S")
    ...
    rmse_path = [r'D:\beijing\rmse\rmse_simple_4_nan_avg_0_3m.csv',
                 r'D:\beijing\rmse\rmse_simple_6_nan_avg_0_3m.csv',
                 r'D:\beijing\rmse\rmse_simple_11_nan_avg_0_3m.csv']
    pred_path = [r'D:\beijing\pred\pred_simple_4_nan_avg_0_3m.csv',
                 r'D:\beijing\pred\pred_simple_6_nan_avg_0_3m.csv',
                 r'D:\beijing\pred\pred_simple_11_nan_avg_0_3m.csv']
    obs_path = [r'D:\beijing\obs\obs_simple_4_nan_avg_0_3m.csv',
                r'D:\beijing\obs\obs_simple_6_nan_avg_0_3m.csv',
                r'D:\beijing\obs\obs_simple_11_nan_avg_0_3m.csv']
    ###################
    # start go go go! #
    ###################
    for exp in range(3):
        ...
        if exp == 0:
            input_size = 4
            para_path = [r'D:\beijing\para\para_simple_4_nan_avg_0_3m\4_' + str(i) + '.pth' for i in range(point_nums)]
        if exp == 1:
            input_size = 6
            para_path = [r'D:\beijing\para\para_simple_6_nan_avg_0_3m\6_' + str(i) + '.pth' for i in range(point_nums)]
        if exp == 2:
            input_size = 11
            para_path = [r'D:\beijing\para\para_simple_11_nan_avg_0_3m\11_' + str(i) + '.pth' for i in range(point_nums)]
