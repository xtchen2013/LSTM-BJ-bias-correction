...
if __name__ == "__main__":
    ...
    rmse_path = ['./rmse/rmse_rnn_4_nan_avg_0_v6m_t1m_es_Dec.csv',
                 './rmse/rmse_rnn_6_nan_avg_0_v6m_t1m_es_Dec.csv',
                 './rmse/rmse_rnn_11_nan_avg_v6m_t1m_es_Dec.csv']
    pred_path = ['./pred/pred_rnn_4_nan_avg_0_v6m_t1m_es_Dec.csv',
                 './pred/pred_rnn_6_nan_avg_0_v6m_t1m_es_Dec.csv',
                 './pred/pred_rnn_11_nan_avg_0_v6m_t1m_es_Dec.csv']
    ...
    for exp in range(2,3):
        ...
        if exp == 0:
            input_size = 4
            para_path = ['./para_rnn/para_rnn_4_nan_avg_0_v6m_t1m_es_Dec_4_' + str(i) + '.pth' for i in range(point_nums)]
        if exp == 1:
            input_size = 6
            para_path = ['./para_rnn/para_rnn_6_nan_avg_0_v6m_t1m_es_Dec_6_' + str(i) + '.pth' for i in range(point_nums)]
        if exp == 2:
            input_size = 11
            para_path = ['./para_rnn/para_rnn_11_nan_avg_0_v6m_t1m_es_Dec_11_' + str(i) + '.pth' for i in range(point_nums)]
        ...
        with tqdm(total=point_nums) as pbar:
            for num in range(34):
                ...
                rmse_simple, pred_simple, para_simple = simple_rnn()
