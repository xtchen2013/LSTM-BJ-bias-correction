...
def get_dataloader():
    ...
    validate_loader = DataLoader(validate_data, batch_size=batch_size, shuffle=False, num_workers=16)
    # test data
...
def simple_lstm():
    ...
    # model set up
    model = Model(input_input_size=input_size, input_hidden_size=hidden_size, input_dropout_rate=dropout_rate).to(
        DEVICE)
...
if __name__ == "__main__":
    ...
    validate_start = pd.to_datetime("2018-01-31 00:00:00", format="%Y-%m-%d %H:%M:%S")
    ...
    test_end = pd.to_datetime("2019-01-31 23:00:00", format="%Y-%m-%d %H:%M:%S")
    #############
    # file path #
    #############
    caqra_path = ['caqra_4_nan_avg_0.csv', 'caqra_6_nan_avg_0.csv', 'caqra_11_nan_avg_0.csv']
    rmse_path = [r'D:\beijing\rmse\rmse_simple_4_nan_avg_0_v12m_t1m_es_Jan.csv',
                 r'D:\beijing\rmse\rmse_simple_6_nan_avg_0_v12m_t1m_es_Jan.csv',
                 r'D:\beijing\rmse\rmse_simple_11_nan_avg_v12m_t1m_es_Jan.csv']
    pred_path = [r'D:\beijing\pred\pred_simple_4_nan_avg_0_v12m_t1m_es_Jan.csv',
                 r'D:\beijing\pred\pred_simple_6_nan_avg_0_v12m_t1m_es_Jan.csv',
                 r'D:\beijing\pred\pred_simple_11_nan_avg_0_v12m_t1m_es_Jan.csv']
    obs_path = [r'D:\beijing\obs\obs_simple_4_nan_avg_0_v12m_t1m_es_Jan.csv',
                r'D:\beijing\obs\obs_simple_6_nan_avg_0_v12m_t1m_es_Jan.csv',
                r'D:\beijing\obs\obs_simple_11_nan_avg_0_v12m_t1m_es_Jan.csv']
    ###################
    # start go go go! #
    ###################
    for exp in range(3):
        ...
        if exp == 0:
            input_size = 4
            para_path = [r'D:\beijing\para\para_simple_4_nan_avg_0_v12m_t1m_es_Jan\4_' + str(i) + '.pth' for i in range(point_nums)]
            continue
        if exp == 1:
            input_size = 6
            para_path = [r'D:\beijing\para\para_simple_6_nan_avg_0_v12m_t1m_es_Jan\6_' + str(i) + '.pth' for i in range(point_nums)]
            continue
        if exp == 2:
            input_size = 11
            para_path = [r'D:\beijing\para\para_simple_11_nan_avg_0_v12m_t1m_es_Jan\11_' + str(i) + '.pth' for i in range(point_nums)]
