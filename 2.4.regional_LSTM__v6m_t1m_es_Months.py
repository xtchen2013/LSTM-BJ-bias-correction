...
if __name__ == "__main__":
    ...
    # file path #
    #############
    rmse_path = [r'D:\beijing\rmse\rmse_regional_11_nan_avg_v6m_t1m_es_Month' + str(i+1) + '.csv' for i in range(12)]
    pred_path = [r'D:\beijing\pred\pred_regional_11_nan_avg_0_v6m_t1m_es_Month' + str(i+1) + '.csv' for i in range(12)]
    obs_path = [r'D:\beijing\obs\obs_regional_11_nan_avg_0_v6m_t1m_es_Month' + str(i+1) + '.csv' for i in range(12)]
    para_path = [r'D:\beijing\para\para_regional_11_nan_avg_0_v6m_t1m_es_month_' + '\\11_' + str(i+1) + '.pth' for i in range(12)]
    ###################
    # start go go go! #
    ###################
    for month in range(12):
        ...
        point_nums = 34
        input_size = 11
        para_path = [r'D:\beijing\para\para_regional_11_nan_avg_0_v6m_t1m_es_month_' + str(month + 1) + '\\11_'
        ...
        with tqdm(total=point_nums) as pbar:
            for num in range(34):
                ...
                if num == (point_nums - 1):
                    torch.save(para_last_point, para_path[month])
                pbar.update(1)
